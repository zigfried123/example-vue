...
import Action2020 from '../../../src/common/components/navbar/Action2020.vue'
...
if ($('#id_action2020').length) {
    new Vue({
        el: '#id_action2020',
        store,
        render: h => h(Action2020)
    });
}
...
/*
if ($('#actionRobbery').length) {
    new Vue({
        el: '#actionRobbery',
        render: h => h(ActionRobbery)
    });
}*/
...
if ($('#action2019').length) {
    new Vue({
        el: '#action2019',
        render: h => h(Action2019)
    });
}
if ($('#action2019Detailed').length) {
    new Vue({
        el: '#action2019Detailed',
        render: h => h(Action2019Detailed)
    });
}
