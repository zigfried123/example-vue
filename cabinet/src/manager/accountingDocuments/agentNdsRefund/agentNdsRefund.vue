<template>
    <div>
        <header-doc
                title="Компенсация НДС при работе в рекламной системе"
                :status="status"
                    ...
                    <div class="md-layout-item md-size-50 md-size-50 md-small-size-100 md-xsmall-size-100">
                        ...
                        <md-field :class="getValidationClass('amount')">
                            <md-input type="number"
                                      placeholder="Укажите сумму компенсации"
                                      required
                                      :disabled="isViewMode"
                                      v-model="amount"
...
<script>
    ...
    export default {
        ...
        data: () => ({
            webmaster_id: '',
            saveParams: {
                formName: 'common_modules_accounting_documents_models_AgentNdsRefundForm'
            },
        }),
        props: {
