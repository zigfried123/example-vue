<template>
    <md-card-content>
        ...
        <div class="md-layout md-gutter">
            ...
            <div class="md-layout-item md-size-50 md-small-size-100 md-xsmall-size-100">
                <select2 :disabled="true"
                         :value.sync="affiliateOrganizationId"
                         :searchingUrl="urlAffiliateOrganization()"
                         ref="affiliateOrganization"
                         title="Организация вебмастера"/>
            </div>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            affiliateOrganizationId: function (val) {
                this.$refs.affiliateOrganization.initWithValue(val);
            },
        },
        methods: {
